...
<div class="login-container">
    <div class="login-card">
        ...
        <!-- Role Selection Tabs -->
        <div class="role-tabs">
            <button type="button" class="role-tab active" data-role="farmer" onclick="selectRole('farmer')">Farmer</button>
        ...
        <form method="POST" action="" id="loginForm">
            ...
            <div class="remember-forgot">
                ...
                <a href="#" class="text-primary-green" style="text-decoration: none; font-weight: 600;">Forgot password?</a>
            </div>
        ...
        <div class="text-center mt-4">
            <p class="mb-0">New to AgriRent? <a href="register.php" class="text-primary-green fw-bold" style="text-decoration: none;">Create an account</a></p>
        </div>
    </div>
</div>
